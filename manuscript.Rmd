...
Even though this statistic may be different specifically for data scientists, the data science field is broad with the intersection in careers as developers (e.g., data dashboard developers) and designers (e.g., data visualization experts). 
...
For instance, many introductory data science courses [@yan2019first; @baumer2015data], textbooks [@adhikari2019computational; @wickham2016r], or curricula [@schwab2021data] either fail to mention accessibility at all or only focus on the accessibility of data. 
