...
Despite the increasing demand for accessibility knowledge in both industries and academia, accessibility from disabilities perspectives has not yet found its place in the data science course materials.
One main reason for this could be that accessibility is often covered in the computer sciences [@kawasTeachingAccessibilityDesign2019] or the digital arts [@barata2019inclusion], if at all covered.
