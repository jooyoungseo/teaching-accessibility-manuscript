...
```{r plot-xy, fig.cap="Visualizing the relationship of two numerical variables with scatter plot.", fig.alt="Scatter plot representing the positive relationship between x and y variables.", echo=FALSE, fig.height=3}
# Prepare variables
x <- 1:5
y <- 1:5
