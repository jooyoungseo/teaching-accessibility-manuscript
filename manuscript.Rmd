...
```{r VI-example, fig.cap = "Automatic data verbalization.", fig.alt = "Histogram of Ozone with its verbal description automatically generated by `BrailleR::VI()` function.", echo=TRUE, include=TRUE, warning=FALSE, cache=TRUE}
library(BrailleR)
...
<!-- ```{r manual-alt, fig.cap = "Figure caption.", fig.alt = "Alt text."} -->
