...
We argue that instructors need to teach multiple data representation methods so that all students of all abilities can benefit from multi-sensory data augmentation. To this end, we have considered multi data representations and their relation to accessibility in our courses, and that's what we will demonstrate throughout this paper.
...
```{r plot-xy, fig.cap="Visualizing the relationship of two numerical variables with scatter plot.", fig.alt="Scatter plot representing the positive relationship between x and y variables.", echo=FALSE, fig.height=5}
# Prepare variables
x <- 1:5
y <- 1:5
...
```{r tactile-example, echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, dependson="tactile-producing-code", fig.cap="Ready-to-print tactile graph in braille.", fig.alt="Boxplot showing the different body mass between penguins species", , fig.align = "center", out.height="50%"}
