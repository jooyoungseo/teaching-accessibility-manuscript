...
Although there are various ways to represent data patterns and models, visualization has been primarily taught in many data science courses for its efficiency (cite). 
...
In addition we rely on `ggplot2::scale_fill_viridis_d()` for generating `ggplot` visualizations [@ggplot22016] that can be perceived by those with common forms of color blindness. 
