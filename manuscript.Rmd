...
We show an example of incorporating these three basic rules by using the Palmer Penguins data <!--Mine will cite this-->. 
...
The `colorblindr` package provides a set of functions that can be useful in teaching and practising color blindness accessibility. 
For instance, `cvd_grid()` function provides color-deficiency simulations of a given plot. 
